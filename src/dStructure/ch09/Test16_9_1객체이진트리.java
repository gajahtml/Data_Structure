...
class Tree4 {
	...
	public boolean delete(SimpleObject5 obj, Comparator<? super SimpleObject5> c) {
		...
		if (p.LeftChild == null) {
			...
			TreeNode4 leftChild = inorderSucc(p);
			TreeNode4 leftChildParent = findParent(leftChild, c);

			p.data = leftChild.data;
			leftChildParent.LeftChild = leftChild.RightChild;
		}
