...
import dStructure.ch09.ObjectQueue5.EmptyQueueException;
import dStructure.ch09.ObjectStack5.EmptyGenericStackException;
...
class Tree5 {
	...
	boolean insert(int x) {// binary search tree를 만드는 입력 : left subtree < 노드 x < right subtree
		...
		TreeNode5 p = root;
		TreeNode5 q = null;
		TreeNode5 newTree = new TreeNode5(x);
